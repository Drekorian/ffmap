...
public class viewCheapestJointsMapServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        String javaScript = "";
        
        try {
            List<Joint> joints = (List<Joint>)JointManager.getInstance().getCheapest();
            ...
            Logger.getLogger(viewCheapestJointsMapServlet.class.getName()).log(Level.SEVERE, ex.getMessage(), ex);
